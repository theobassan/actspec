...
// Adapted from spike/node-sandbox/src/protocol.ts.
...
// Parse ::set-output name=<n>::<v> legacy workflow commands from stdout.
// (Deprecated but still used by some actions.)
